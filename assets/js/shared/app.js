...
function buildSearch() {
  ...
  // Shut until it is wanted. A page that filters its own rows already has a field
  // for that, so this one is a button with the key that opens it written on its face.
  ...
  // Folding it away clears it, so it never reopens holding somebody's last search.
